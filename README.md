...
There are three inputs for input data: 1) target_scanner_image_adrs, (2) external_scanner_image_adrs, and (3) CVfolds_adrs.
```
...
--source_scanner_image_adrs "./Dataset/ResGAN_Configuration/ExternalScanner" --CVfolds_adrs\
